...
class TokenEmbedding(nn.Module):
    ...
    ''' Function: forward
        Description: Convert token indices to embedding vectors.
        Args:
...
class PositionalEncoding(nn.Module):
    ...
    ''' Function: forward
        Description: Add positional encoding to input embeddings.
        Args:
            x      : Input tensor with token embeddings.
            offset : Starting position offset for encoding.
        Returns:
